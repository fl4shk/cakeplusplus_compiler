...
define(`_SIGN_EXTEND_TO_64',_BOLD(sign\_extend\_to\_64)`($1)')dnl
define(`_ZERO_EXTEND_TO_64',_BOLD(zero\_extend\_to\_64)`($1)')dnl
define(`_CAST_TO_64',_BOLD(cast\_to\_64)`($1)')dnl
...
define(`_INT16_T',`_MDCODE(int16_t)')dnl
define(`_UINT32_T',`_MDCODE(uint32_t)')dnl
define(`_INT32_T',`_MDCODE(int32_t)')dnl
define(`_UINT64_T',`_MDCODE(uint64_t)')dnl
define(`_INT64_T',`_MDCODE(int64_t)')dnl
