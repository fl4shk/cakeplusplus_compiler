...
//	}
//}
//void Interpreter::visit_list_ident(AstListIdent* p)
//{
//	for (auto iter : p->list)
//	{
//		iter->accept(this);
...
//	if (sym != nullptr)
//	{
//		printerr("visit_var_decl_with_init():  ",
//			"There is already a symbol with name \"", *ident_str,
//			"\"!\n");
//		exit(1);
//	}
...
//	const auto expr = pop_num();
//
//	printout("Initializing \"", *ident_str, "\" to ", expr, "\n");
//	Symbol to_insert_or_assign(*ident_str, SymType::VarName);
//	to_insert_or_assign.data().push_back(expr);
//	sym_tbl.insert_or_assign(std::move(to_insert_or_assign));
//}
//
//
//void Interpreter::visit_multi_var_decl(AstMultiVarDecl* p)
//{
//	p->builtin_typename_node()->accept(this);
//
//
